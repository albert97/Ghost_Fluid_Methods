...
void Display_2DarrayN4(vector<vector<double>>const &data){
...
vector<vector<int>> interface_finding(vector<vector<double>>const &phi, int N){
...
void Reimann_boundary_extrapolation(int X, int Y,int N, double &PL, double &PR, const double dx,  vector<vector<double>>const &property, vector<vector<double>> const &property_extend,  vector<vector<double>>const &phi, const double *Normal){
    ...
    for (int i =0; i<2;i++){
        ...
        //  cout<< XP1[i] << "\t=\t"<< XP[i]<<"\t+\t" <<1.5 <<"\t*\t"<< dx<< "\t*\t"<< Normal[i];
        
        //Left materal
        
        XP2[i] = XP[i] - 1.5 * dx * Normal[i];
        
        //   cout<< XP2[i]  << "\t=\t"<< XP[i]<<"\t-\t" <<1.5 <<"\t*\t"<< dx<< "\t*\t"<< Normal[i];
        
        
    }
    //  cout<<"XP1\t"<<XP1[0]<<"\tXP1\t"<<XP1[1]<<"\tXP2\t"<<XP2[0]<<"\tXP2\t"<<XP1[1]<<endl;
    double XP1_temp1 =  XP1[0] * double (N); // The y value
    double XP1_temp2 =  XP1[1] * double (N); // The x value
    
    double XP2_temp1 =  XP2[0] * double(N); // The y value
    double XP2_temp2 =  XP2[1] * double(N); // The x value
    ...
    if ( Normal[0] >= 0 && Normal[1]>= 0){
        ...
        if(XR1 > 0 && XR2 > 0 && YR1 > 0 && YR2 > 0 && XR1 <N && XR2 <N && YR1 < N && YR2 < N){
            ...
            //      cout<<"For boundary cells\t"<<"\tx1\t"<<XR1+2<<"\ty1\t"<< YR1+2 <<"\tx2\t"<< XR2+2<<"\ty2\t"<<YR2+2<<endl;
        ...
        if(XL1 > 0 && XL2 > 0 && YL1 >0 && YL2 > 0&& XL1 <N && XL2 <N && YL1 < N && YL2 < N){
            ...
            //     cout<<"For boundary cells\t"<<"\tx1\t"<<XL1+2<<"\ty1\t"<< YL1+2 <<"\tx2\t"<< XL2+2<<"\ty2\t"<<YL2+2<<endl;
...
/*
 ...
 density1[i][j] = density[i][j];
 density2[i][j] = density[i][j];
 uspeed1[i][j] = normalvelocity[i][j];
 uspeed2[i][j] = normalvelocity[i][j];
 pressure1[i][j] = pressure[i][j];
 pressure2[i][j] = pressure[i][j];
 ...
 //   cout<<"First interface location\t"<<IFY[0][i]<<endl;
 
 //cout<<"dISTANCE BETWEEN INTERFACE \t"<<((double(IFY[1][i]) - double(IFY[0][i])) != (double(IFY[1][0]) - double(IFY[0][0])))<<endl;
 ...
 uspeed1[i][IFY[0][i]] = DUP_L1[1];
 // cout<<"  uspeed1[i][IFY[0][i]]\t"<<  uspeed1[i][IFY[0][i]];
 uspeed1[i][IFY[1][i] - 1] = DUP_R2[1];
 //cout<<"\tuspeed1[i][IFY[1][i] - 1] \t"<<endl;
 uspeed2[i][IFY[0][i] - 1] = DUP_R1[1];
 uspeed2[i][IFY[1][i]] = DUP_L2[1];
...
// Ghost Luid backward to populate two materials's backward regions
...
void Combinevelcoityvectors( vector<vector<int>>const &IFY, vector<vector<double>> const tangentialvelocity ,vector<vector<double>>& uspeed1, vector<vector<double>>& uspeed2, vector<vector<double>>& vspeed1,vector<vector<double>>& vspeed2, int N){
    ...
    for (int i =0; i< N; i++){
        ...
        if (IFY[0][i]==0 && IFY[1][i] > 0  && ((double(IFY[1][i]) - double(IFY[0][i])) != (double(IFY[1][0]) - double(IFY[0][0])))){
            ...
            double temp_nvelocity1, temp_nvelocity2;
            temp_nvelocity1 = uspeed1[i][IFY[1][i] -1];
            temp_nvelocity2 = uspeed2[i][IFY[1][i]];
            
            uspeed1[i][IFY[1][i] -1] =   temp_nvelocity1 * cos(0.5 * M_PI - IFrad) + tangentialvelocity[i][IFY[1][i] -1] * cos(IFrad);
            uspeed2[i][IFY[1][i]] =  temp_nvelocity2 * cos(0.5 * M_PI - IFrad) + tangentialvelocity[i][IFY[1][i]] * cos(IFrad) ;
            vspeed1[i][IFY[1][i] -1] = temp_nvelocity1 * sin(0.5 * M_PI - IFrad) + tangentialvelocity[i][IFY[1][i] -1] * sin(IFrad);
            vspeed2[i][IFY[1][i]] =  temp_nvelocity2 * sin(0.5 * M_PI - IFrad) +  tangentialvelocity[i][IFY[1][i]] * sin(IFrad);
            
        }
        else{
            
            //
            //double interfaces cases
            //
            if( IFY[0][i] == 0){
                
                double temp_nvelocity1, temp_nvelocity2, temp_nvelocity3;
                temp_nvelocity1 = uspeed1[i][IFY[1][i] -1];
                temp_nvelocity2 = uspeed2[i][IFY[1][i]];
                temp_nvelocity3 = uspeed1[i][IFY[0][i]];
                
                
                uspeed1[i][IFY[0][i]]  =  temp_nvelocity3  * cos(0.5 * M_PI - IFrad)+ tangentialvelocity[i][IFY[0][i]] * cos(IFrad);
                uspeed1[i][IFY[1][i] -1] = temp_nvelocity1 * cos(0.5 * M_PI - IFrad) + tangentialvelocity[i][IFY[1][i] -1] * cos(IFrad);
                uspeed2[i][IFY[1][i]] = temp_nvelocity2  * cos(0.5 * M_PI - IFrad)+ tangentialvelocity[i][IFY[1][i]] * cos(IFrad);
                
                vspeed1[i][IFY[0][i]]  =  temp_nvelocity3  * sin(0.5 * M_PI - IFrad)+ tangentialvelocity[i][IFY[0][i]] * sin(IFrad);
                vspeed1[i][IFY[1][i] -1] = temp_nvelocity1 * sin(0.5 * M_PI - IFrad) + tangentialvelocity[i][IFY[1][i] -1] * sin(IFrad);
                vspeed2[i][IFY[1][i]] = temp_nvelocity2  * sin(0.5 * M_PI - IFrad)+ tangentialvelocity[i][IFY[1][i]] * sin(IFrad);
                ...
                double temp_nvelocity1, temp_nvelocity2, temp_nvelocity3,temp_nvelocity4 ;
                temp_nvelocity1 = uspeed1[i][IFY[1][i] -1];
                temp_nvelocity2 = uspeed2[i][IFY[1][i]];
                temp_nvelocity3 = uspeed1[i][IFY[0][i]];
                temp_nvelocity4 = uspeed2[i][IFY[0][i] - 1];
                
                uspeed1[i][IFY[0][i]] = temp_nvelocity3  * cos(0.5 * M_PI - IFrad) + tangentialvelocity[i][IFY[0][i]] * cos(IFrad) ;
                uspeed1[i][IFY[1][i] - 1] =  temp_nvelocity1  * cos(0.5 * M_PI - IFrad) + tangentialvelocity[i][IFY[1][i] - 1] * cos(IFrad);
                uspeed2[i][IFY[0][i] - 1] =  temp_nvelocity4  * cos(0.5 * M_PI - IFrad) + tangentialvelocity[i][IFY[0][i] - 1] * cos(IFrad);
                uspeed2[i][IFY[1][i]] = temp_nvelocity2  * cos(0.5 * M_PI - IFrad) +  tangentialvelocity[i][IFY[1][i]] * cos(IFrad);
                
                
                vspeed1[i][IFY[0][i]] = temp_nvelocity3  * sin(0.5 * M_PI - IFrad) + tangentialvelocity[i][IFY[0][i]] * sin(IFrad) ;
                vspeed1[i][IFY[1][i] - 1] =  temp_nvelocity1  * sin(0.5 * M_PI - IFrad) + tangentialvelocity[i][IFY[1][i] - 1] * sin(IFrad);
                vspeed2[i][IFY[0][i] - 1] =  temp_nvelocity4  * sin(0.5 * M_PI - IFrad) + tangentialvelocity[i][IFY[0][i] - 1] * sin(IFrad);
                vspeed2[i][IFY[1][i]] = temp_nvelocity2  * sin(0.5 * M_PI - IFrad) +  tangentialvelocity[i][IFY[1][i]] * sin(IFrad);
...
void freeMemory(double **property, int N) {
...
void freeMemorySingle(double *property){
...
int main(void){
    ...
    interfacey= interface_finding(phi,  N);
    ...
    /*   for (int i =0 ;i<2; i++){
     ...
     cout<<interfacex[i][j]<<"\t,\t "<<interfacey[i][j]<<"\t";
     }
     cout<<"\n";
     }
     */
    ...
    do{
        ...
        for (int i =0 ; i<N; i++){
            ...
            for (int j =0; j<N; j++){
                ...
                //   normalvelocity[i][j] = uspeed[i][j] ;
                
                //        tangentialvelocity[i][j] =  vspeed[i][j];
        ...
        pressure_extend = GF_Domain_boundaryConditions(N, pressure);
        density_extend = GF_Domain_boundaryConditions(N, density);
        normalvelocity_extend = GF_Domain_boundaryConditions(N, normalvelocity);
        ...
        //     Riemann_based_Ghost_Fluid_Boundary( interfacex, interfacey, N, dx, pressure,  density, normalvelocity,  pressure_extend,  density_extend, normalvelocity_extend,  phi, density1, density2, uspeed1, uspeed2, pressure1, pressure2, Normal1, Normal2);
        
        
        
        
        cout<<" After Exact Riemann Solver Material 1"<<endl;
        
        Display_2DarrayN(uspeed1);
        
        cout<<"\n";
        
        Display_2DarrayN(uspeed2);
        
        //  Display_ERS (uspeed1, vspeed1, density1, pressure1, energy1, N);
        
        //Display_ERS (uspeed2, vspeed2, density2, pressure2, energy2, N);
        
        Combinevelcoityvectors( interfacey, tangentialvelocity, uspeed1, uspeed2, vspeed1, vspeed2, N);
        ...
        /*
         cout<<" After xforward sweep Material 1"<<endl;
         
         Display_ERS (uspeed1, vspeed1, density1, pressure1, energy1, N);
         
         cout<<" After  xforward sweep Material 2"<<endl;
        ...
        /*
         ...
         cout<<"results before sweep"<<endl;
        ...
        /*
         ...
         cout<<" before x sweep update Material 1"<<endl;
        ...
        for (int i = 0 ; i< N;i++){
            ...
            for (int j =0; j < interfacey[0][i] ; j++){
            ...
            for (int j = interfacey[0][i]; j<interfacey[1][i]; j++){
            ...
            for (int j = interfacey[1][i]; j<N; j++){
        ...
        /*
         cout<<"Density1 Profile"<<endl;
         
         Display_2DarrayN( density1);
         
         cout<<"\n";
         
         cout<<"Velocity1 Profile"<<endl;
         
         Display_2DarrayN(uspeed1);
         
         cout<<"\n";
         
         cout<<"VelocityY1 Profile"<<endl;
         
         Display_2DarrayN(vspeed1);
         
         cout<<"\n";
         
         cout<<"Pressure1 Profile"<<endl;
         
         Display_2DarrayN(pressure1);
         
         cout<<"\n";
         
         cout<<"Density2 Profile"<<endl;
         
         Display_2DarrayN( density2);
         
         cout<<"\n";
         
         cout<<"\n";
         
         cout<<"Velocity2 Profile"<<endl;
         
         Display_2DarrayN(uspeed2);
         
         cout<<"\n";
         
         cout<<"VelocityY2 Profile"<<endl;
         
         Display_2DarrayN(vspeed2);
         
         cout<<"\n";
         
         cout<<"Pressure2 Profile"<<endl;
         
         Display_2DarrayN(pressure2);
         */
    ...
    plotfile.open("plot2DY_Alighned_Interface_Final_new_100.dat", fstream::out);
    ...
    for (int i=0;i<N;i++){
        ...
        plotfile<<x<<"\t"<<uspeed[50][i]<<"\t"<<density[50][i]<<"\t"<<pressure[50][i]<<"\t"<<energy[50][i]<<"\t"<<phi[50][i]<<endl;
    }
