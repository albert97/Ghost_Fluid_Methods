   ...
   //Initial conditions for Exact Solver
    ...
    cout<< "interface 2 \t"<< density[N2] <<"\t"<<"interface 2 \t "<<density[N2+1]<<"\n";
       ...
       do{
           ...
           Riemann_based_Ghost_Fluid_Boundary( N1, N2, N, dx, pressure, density, uspeed,  density1,  density2,  uspeed1,  uspeed2,  pressure1,  pressure2, phi, U1,  U2);
...
*/
    ...
    plotfile.open("plotMM_Shock_Tube_gasesTest2_100.dat", fstream::out);
    ...
    delete[] uspeed1_extend2 ;
    delete[] density1_extend2 ;
    delete[] pressure1_extend2 ;
    delete[] uspeed2_extend2 ;
    delete[] density2_extend2 ;
    delete[] pressure2_extend2 ;
